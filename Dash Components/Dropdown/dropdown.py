...
df = pd.read_csv(
    "https://raw.githubusercontent.com/Coding-with-Adam/Dash-by-Plotly/master/Dash%20Components/Dropdown/Urban_Park_Ranger_Animal_Condition.csv")
...
app.layout = html.Div([
    ...
    html.Div([
        ...
        html.Label(['Choose column:'], style={
