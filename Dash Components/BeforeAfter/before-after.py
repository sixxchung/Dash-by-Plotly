...
# pip install dash-extensions==0.0.47 or higher
...
app.layout = dbc.Container([
    dbc.Row(
        dbc.Col([
            html.H1("Before-After Dash Component",
    ...
    dbc.Row([
        dbc.Col([
            ...
            BeforeAfter(before="assets/beirut1.jpg", after="assets/beirut2.jpg",
                        width=512, height=412, defaultProgress=0.5),
        ], width=6),
        dbc.Col([
            # https://sustainableearth.blog/2019/05/06/changes-in-marine-habitats/
            html.H2("Conservation"),
            BeforeAfter(before="assets/reef1.jpg",
                        after="assets/reef2.jpg", width=512, height=412),
        ], width=6)
    ...
    dbc.Row([
        dbc.Col([
            ...
            BeforeAfter(before="assets/ciona-egg1.png",
                        after="assets/ciona-egg2.png", width=512, height=412),
        ], width=6),
        dbc.Col([
            # https://pressbooks-dev.oer.hawaii.edu/chemistry/chapter/writing-and-balancing-chemical-equations/
            html.H2("Chemistry"),
            BeforeAfter(before="assets/chemistry1.jpg",
                        after="assets/chemistry2.jpg", width=512, height=412),
        ], width=6)
    ], className='mb-5'),
])
