...
df = pd.read_excel("Vizforsocialgood.xlsx", engine='openpyxl',
                   sheet_name="2018", header=None)
df = df.transpose()
...
df = pd.melt(df, id_vars=['Country', 'Local partner', 'Project title', 'Axis of intervention',
                          ...
                          'iso_alpha'],
             value_vars=['2018 results', '2018 results2',
                         '2018 results3', '2018 results4', '2018 results5'],
